  ...
  describe 'gera um código automaticamente' do
    ...
    context '#valid?' do
      ...
      it 'Falso quando o Comprimento do produto (product_length) estiver em branco' do
        # Arrange
        order = Order.new(origin_address: 'Rodovia Presidente Dutra, Km 228, Guarulhos - SP', id_code: '82P5D8BSAJQBARI', product_length: nil, product_height: 91, product_width: 76, product_weight: 6.42, destination_address: 'Rua Padre Valdevino, 1880, Fortaleza - CE', status: 0)
      ...
      it 'Falso quando a Altura do produto (product_height) estiver em branco' do
        # Arrange
        order = Order.new(origin_address: 'Rodovia Presidente Dutra, Km 228, Guarulhos - SP', id_code: '82P5D8BSAJQBARI', product_length: 115, product_height: nil, product_width: 76, product_weight: 6.42, destination_address: 'Rua Padre Valdevino, 1880, Fortaleza - CE', status: 0)
      ...
      it 'Falso quando a Largura do produto (product_width) estiver em branco' do
        # Arrange
        order = Order.new(origin_address: 'Rodovia Presidente Dutra, Km 228, Guarulhos - SP', id_code: '82P5D8BSAJQBARI', product_length: 115, product_height: 91, product_width: nil, product_weight: 6.42, destination_address: 'Rua Padre Valdevino, 1880, Fortaleza - CE', status: 0)
      ...
      it 'Falso quando o Peso do produto (product_weight) estiver em branco' do
        # Arrange
        order = Order.new(origin_address: 'Rodovia Presidente Dutra, Km 228, Guarulhos - SP', id_code: '82P5D8BSAJQBARI', product_length: 115, product_height: 91, product_width: 76, product_weight: nil, destination_address: 'Rua Padre Valdevino, 1880, Fortaleza - CE', status: 0)
      ...
      it 'Falso quando o Endereço de destino (destination_address) estiver em branco' do
        # Arrange
        order = Order.new(origin_address: 'Rodovia Presidente Dutra, Km 228, Guarulhos - SP', id_code: '82P5D8BSAJQBARI', product_length: 115, product_height: 91, product_width: 76, product_weight: 6.42, destination_address: '', status: 0)
      ...
      it 'Falso quando o status estiver em branco' do
        # Arrange
        order = Order.new(origin_address: 'Rodovia Presidente Dutra, Km 228, Guarulhos - SP', id_code: '82P5D8BSAJQBARI', product_length: 115, product_height: 91, product_width: 76, product_weight: 6.42, destination_address: 'Rua Padre Valdevino, 1880, Fortaleza - CE', status: nil)
