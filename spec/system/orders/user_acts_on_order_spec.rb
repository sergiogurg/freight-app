...
describe 'Usuário de Transportadora interage com a Ordem de Serviço' do
  ...
  it 'e desbloqueia um link para ver informações da rota quando a Ordem está aprovada' do
    # Arrange
    shipping_company = ShippingCompany.create!(corporate_name: 'Fedex Brasil Logistica e Transporte LTDA', brand_name: 'FedEx', registration_number: '10970887000285', email_domain: '@fedex.com.br', address: 'Rodovia Presidente Dutra, Km 228, Guarulhos - SP')
    ...
    order = Order.create!(status: 'approved', id_code: 'VWJGX1FHUHENKC6', origin_address: 'Avenida Alberto Byington, 1933, São Paulo - SP', product_length: 115, product_height: 91, product_width: 76, product_weight: 6.42, destination_address: 'Rua Padre Valdevino, 1880, Fortaleza - CE', shipping_company: shipping_company)
    ...
    # Assert
    expect(page).to have_link('Rota de entrega')
  end
end